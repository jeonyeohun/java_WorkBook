...
2019.01.28 Log
> 메뉴판 프로그램 완성. 아직 객체지향의 개념이 확실하지 않아서 완전히 객체지향으로 만들지는 못했다. 더 공부가 필요해 보임.

2019.02.18 Log
> 포항에 노트북을 두고 서울로 올라간 덕분에 2주동안 원없이 놀다 다시 포항으로 내려왔다. 새섬워크샵, 한스트 때문에 당분간 자바문제풀기는 불가능할 것 같다. 개강 후에 다시 공부에 집중 할 수 있도록! 그나저나 새내기들이 너무 기다려진다ㅠ
